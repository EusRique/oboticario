...
import { makeRemovePurchaseController } from '../factories/controllers/purchase/remove/remove-purchase-controller-factory'
...
export default (router: Router): void => {
  ...
  router.delete('/purchases/:purchaseId', auth, adaptRoute(makeRemovePurchaseController()))
}
